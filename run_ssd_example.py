...
#run run_ssd_example.py mb1-ssd-lite-025extra  models/ws0.25tmax400extra0.25/mb1-ssd-lite-025extra-Epoch-399-Loss-3.2293308803013394.pth models/voc-model-labels.txt image/01_3PTeam.png
...
#     net = create_mobilenetv1_ssd_lite(len(class_names), is_test=True)
     ...
     net = create_mobilenetv1_ssd_lite(len(class_names), width_mult=0.25, is_test=True)
