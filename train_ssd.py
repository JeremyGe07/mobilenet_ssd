...
from vision.ssd.config import mobilenetv1_ssd_config, mbv1_ssd_224_config, mbv1_ssd_config_4box,mobilenetv1_ssd_384_config,mobilenetv1_ssd_config_3box
...
#new: nohup python train_ssd.py --dataset_type voc --datasets VOC2007 --net mb1-ssd-lite-025extra --base_net mobilenet_v1_size_224_alpha_0.25_top.pth --lr 0.01 --batch_size 8 --num_epochs 400 --scheduler cosine --t_max 400 --num_workers 4 --checkpoint_folder 'DDDDD' --width_mult 0.25  --validation_dataset VOC2007
