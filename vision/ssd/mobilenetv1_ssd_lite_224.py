...
from .config import mbv1_ssd_224_config as config
...
def create_mobilenetv1_ssd_lite_025extra_224(num_classes,width_mult=1.0, is_test=False):
    ...
    regression_headers = ModuleList([
        Conv2d(in_channels=round(512 * width_mult), out_channels=6 * 4, kernel_size=3, padding=1),
        Conv2d(in_channels=round(1024 * width_mult), out_channels=6 * 4, kernel_size=3, padding=1),
        Conv2d(in_channels=round(512* width_mult), out_channels=6 * 4, kernel_size=3, padding=1),
        Conv2d(in_channels=round(256* width_mult), out_channels=6 * 4, kernel_size=3, padding=1),
        Conv2d(in_channels=round(256* width_mult), out_channels=6 * 4, kernel_size=3, padding=1),
    ])

    classification_headers = ModuleList([
        Conv2d(in_channels=round(512 * width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
        Conv2d(in_channels=round(1024 * width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
        Conv2d(in_channels=round(512* width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
        Conv2d(in_channels=round(256* width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
        Conv2d(in_channels=round(256* width_mult), out_channels=6 * num_classes, kernel_size=3, padding=1),
    ])
...
def create_mobilenetv1_ssd_lite_predictor224(net, candidate_size=200, nms_method=None, sigma=0.5, device=None):
