...
def create_mobilenetv1_ssd_lite(num_classes,width_mult=1.0, is_test=False,cfg=None):
    ...
    regression_headers = ModuleList([
        SeperableConv2d(in_channels=out1, out_channels=6 * 4, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=out2 , out_channels=6 * 4, kernel_size=3, padding=1),
    ...
    classification_headers = ModuleList([
        SeperableConv2d(in_channels=out1, out_channels=6 * num_classes, kernel_size=3, padding=1),
        SeperableConv2d(in_channels=out2, out_channels=6 * num_classes, kernel_size=3, padding=1),
