...
from .config import mobilenetv1_ssd_384_config as config
...
def create_mobilenetv1_ssd_lite_025extra384(num_classes,width_mult=1.0, is_test=False):
...
def create_mobilenetv1_ssd_lite_predictor384(net, candidate_size=200, nms_method=None, sigma=0.5, device=None):
