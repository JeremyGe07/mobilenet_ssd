# -*- coding: utf-8 -*-
"""
Created on Wed Jul 20 13:48:49 2022
...
fileDir_ann = r'VOCdevkit/VOC2012/Annotations/'
fileDir_img = r'VOCdevkit/VOC2012/JPEGImages/'
  
#存放包含需要的类的图片
saveDir_img = r'VOCdevkit/VOC2012/JPEGImages_ssd2/'
...
for files in os.walk(fileDir_ann):
    ...
    for file in files[2]:
        ...
        #存放包含需要的类的图片对应的xml文件
        saveDir_ann = r'VOCdevkit/VOC2012/Annotations_ssd2/'
